...
public class Tela extends JPanel {
	...
	JPanel panelIdentidficador;
	JLabel lbIdentidficador;
	JTextField tfIdentidficador;
	...
	JComboBox<String> cbPaciente;
	JComboBox<String> cbProfissional;
	...
	private void criarPainelProfissional() {
	    ...
	    btSalvarProfis.addActionListener(new ActionListener(){
	    	public void actionPerformed(ActionEvent e){
	    		// Lógica aqui...
	    		listaProfissionais.add(new Medico(tfRegistro.getText(), tfNomeProfis.getText(), tfContatoProfis.getText()));	    		
	    		TableModelMedico modeloMedico = new TableModelMedico(listaProfissionais);
	    		tabelaProfis.setModel(modeloMedico);
	        }
	    });
	...
	private void criarPainelExame() {
     	panelIdentidficador = new JPanel();
     	panelIdentidficador.setLayout(new FlowLayout());

     	lbIdentidficador = new JLabel("Identificador");
     	lbIdentidficador.setPreferredSize(new Dimension(50, 24));
     	lbIdentidficador.setVisible(true);
     	panelIdentidficador.add(lbIdentidficador);
     		
     	tfRegistro = new JTextField();
     	tfRegistro.setPreferredSize(new Dimension(200, 24));
     	panelIdentidficador.add(tfRegistro);
     	...
     	cbTipoExame.addItemListener(new ItemListener() {
     		public void itemStateChanged(ItemEvent arg0) {
     			...
     			if(cbTipoExame.getSelectedItem().equals("LABORATORIAL")) {
     		    	System.out.println("Sou um laboratorial");
     		    }
     		    if(cbTipoExame.getSelectedItem().equals("IMAGEM")) {
     		    	System.out.println("Sou um imagem");
     		    }
     		}
     	});
        ...
        // Evento do botão Adicionar  
     	btSalvarExame.addActionListener(new ActionListener(){
	    	public void actionPerformed(ActionEvent e){  
	    		// Lógica aqui
	    		System.out.println("Aidcionando exame...");
	        }
	    });
		...
		panelFormExame.add(panelIdentidficador);
	...
	private void criarPainelAtendimento() {
		...
		lbHora.setVisible(true);
     	...
     	cbProfissional = new JComboBox<String>();
